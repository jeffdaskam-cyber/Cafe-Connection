 ...
 *
 * Shows a "View Event Report > Week of ..." link. Clicking it expands
...
export default function EventReportDashWidget({ config = {} }) {
  ...
  const handlePrint = () => {
    const iframe = document.getElementById("dash-event-report-preview");
    if (!iframe) return;
    try {
    ...
    >
      {!report ? (
        ...
        <div style={{ padding: "12px 0" }}>
          ...
          >
            View Event Report &rsaquo; {report.weekLabel}
          </button>
        </div>
      ) : (
