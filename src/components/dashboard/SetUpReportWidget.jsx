 ...
 * grouped by campus → date, with prev/next week navigation (defaults to the
 * current week). Managers and above can add, edit, and delete entries.
 *
      ...
      <Widget
        ...
        actions={[
          ...
          ...(readOnly ? [] : [{
            icon: "📧",
            label: "Email",
            // Email links to the app's weekly-ops view (Firestore data); no
